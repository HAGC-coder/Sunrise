<%-- 
    Document   : Playa
    Created on : 20 abr. 2023, 23:24:00
    Author     : hagc
--%>
            ...
            <c:otherwise>
                <div class="sidebar" id="side">
                    ...
                    <label for="check">
                        ...
                        <i class="fas fa-times" id="cancelar"></i> 
                    </label>

                    <ul>
                        <li><a href="Inicio?menu=${categoria}&accion=Listar">Todo</a></li> 
                        <li><a href="Inicio?menu=${categoria}&accion=A-Z">A-Z</a></li> 
                        <li><a href="Inicio?menu=${categoria}&accion=Z-A">Z-A</a></li>  
                    </ul>
                            ...
                            <c:forEach var="p" items="${productos}">
                                <c:if test = "${!productos.isEmpty() && p.getCantidad() > 0}">
                                    <div class="caja articulo" data-aos="zoom-in-up"> 
                                        ...
                                        <input type="hidden" id="id_cli" value="${ cliente.getId_cliente() }"> 
